...
Suppose the time traveler claims that the mean adjusted price of AAPL is higher than 300 in 2020. In a sample data of March, it was found that they are `r sample_mean_price`.

## Is the time traveler a nut? State the hypothesis

- Null hypothesis: the mean adjusted price of AAPL is not higher than 300 in 2020
- Alternative hypothesis: the mean adjusted price of AAPL is higher than 300 in 2020
...
The test statistic `r z_stats` is not larger than the critical value of `r z_alpha`. Hence, at .05 significance level, we do not reject the null hypothesis that the mean adjusted price of AAPL is not higher than 300 in 2020.

---

```{r}
sampled_aapl_adjusted <- as.vector(AAPL["202003"]$AAPL.Adjusted)
t_test <- t.test(sampled_aapl_adjusted, mu = 300, alternative = "greater")
t_test$p.value < 0.05 # Do not reject null hypothesis
```
...
Suppose the time traveler claims that the mean adjusted price of AAPL is lower than 300 in 2020. In a sample data of March, it was found that they are `r sample_mean_price`.

---

- Null hypothesis: the mean adjusted price of AAPL is not lower than 300 in 2020
- Alternative hypothesis: the mean adjusted price of AAPL is lower than 300 in 2020
...
The test statistic `r z_stats` is less than the critical value of `r -z_alpha`. Hence, at .05 significance level, we reject the null hypothesis that the mean adjusted price of AAPL is not higher than 300 in 2020.

---

```{r}
t_test <- t.test(sampled_aapl_adjusted, mu = 300, alternative = "less")
t_test$p.value < 0.05 # Reject null hypothesis
```
