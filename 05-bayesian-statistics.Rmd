...
$$
P(C_1|H_3 \; and \; X_1) = \frac{P(H_3|C_1 \; and \; X_1)P(C_1 \; and \; X_1)}{P(H_3 \; and \; X_1)} = \frac{\frac{1}{2} \times P(C_1 \; and \; X_1)}{P(H_3) \times P(X_1)} \\
= \frac{\frac{1}{2} \times P(C_1) \times P(X_1)}{P(H_3) \times P(X_1)} = \frac{\frac{1}{2} \times \frac{1}{3} \times 1}{\frac{1}{2} \times 1} = \frac{1}{3}
$$

## Calculating the winning probability of "switch"

$$
P(C_2|H_3 \; and \; X_1) = \frac{P(H_3|C_2 \; and \; X_1)P(C_2 \; and \; X_1)}{P(H_3 \; and \; X_1)} = \frac{1 \times P(C_2 \; and \; X_1)}{P(H_3) \times P(X_1)} \\
= \frac{1 \times P(C_2) \times P(X_1)}{P(H_3) \times P(X_1)} = \frac{1 \times \frac{1}{3} \times 1}{\frac{1}{2} \times 1} = \frac{2}{3}
$$
...
$$
P_(Fair|Head) = \frac{P(Head|Fair)P(Fair)}{P(Head)}
$$
...
$$
P_(Biased|Head) = \frac{P(Head|Biased)P(Biased)}{P(Head)}
$$
